        ...
        let notification = ServerNotification::TeamWorkflowSessionUpdated(
            v2::TeamWorkflowSessionUpdatedNotification {
                session: v2::TeamWorkflowSession {
                    ...
                    root_agent: v2::TeamWorkflowRootAgent {
                    ...
                    lifecycle: v2::TeamWorkflowLifecycle {
                        state: v2::TeamWorkflowLifecycleState::Blocked,
                        phase: v2::TeamWorkflowPhase::Review,
                        review_required: true,
                        blocked: true,
                        integration_ready: false,
                        trace_group_id: "thr_root".to_string(),
                        last_transition_at: "2026-03-17T00:00:00Z".to_string(),
                    },
                    handoff: v2::TeamWorkflowHandoff {
                        state: v2::TeamWorkflowLifecycleState::Blocked,
                    ...
                    team_state_index_path: absolute_path(".codex/team-ops/index.json").into(),
            ...
            json!({
                ...
                "params": {
                    "session": {
                        ...
                        "rootAgent": {
                            "agentId": "root-scheduler",
                            "threadId": "thr_root",
                            "role": "root-scheduler",
                            "entrypoint": "turn/start",
                            "nestedAgentsPublic": false
                        },
                        "lifecycle": {
                            "state": "blocked",
                            "phase": "review",
                            ...
                            "traceGroupId": "thr_root",
                            "lastTransitionAt": "2026-03-17T00:00:00Z"
                        },
                        "handoff": {
                            "state": "blocked",
                            "activeDelegateCount": 1,
                            "blockedDelegateCount": 1,
        ...
        let notification = ServerNotification::TeamWorkflowSessionUpdated(
            v2::TeamWorkflowSessionUpdatedNotification {
                session: v2::TeamWorkflowSession {
                    ...
                    lifecycle: v2::TeamWorkflowLifecycle {
                        state: v2::TeamWorkflowLifecycleState::Designing,
                        phase: v2::TeamWorkflowPhase::Design,
                        review_required: true,
                        blocked: false,
                        integration_ready: false,
                        trace_group_id: "thr_root".to_string(),
